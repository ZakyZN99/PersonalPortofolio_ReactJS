                    ...
                    <Card style={{ width: "25rem" }} className="card-projects">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>
                          ...
                          <br/>
                          <br/>
                          <span>Tools: Flutter, Dart, Android Studio, MySQL, Figma</span>
                        </Card.Text>
                        <div className="row-md-2">
                          <button className="button-text1" onClick={DTfigmaLink}>
                            Figma Link
                          </button>
                          <button className="button-text1" onClick={DTgithubLink}>
                            GitHub Link
                          </button>
                        </div>
                      </Card.Body>
                  ...
                  <CardGroup className="card-group">
                    <Card style={{ width: "25rem" }} className="card-projects">
                      ...
                      <Card.Body>
                        ...
                        <div className="row-md-2">
                          <button className="button-text1" onClick={SINANASCertif}>
                            Certificate
                          </button>
                        </div>
                      </Card.Body>
                    ...
                    <Card style={{ width: "25rem" }} className="card-projects">
                      ...
                      <Card.Body>
                        ...
                        <div className="row-md-2">
                          <button className="button-text1" onClick={SIFIRINGSgithubLink}>
                            GitHub Link
                          </button>
                        </div>
                      </Card.Body>
